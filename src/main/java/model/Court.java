...
public class Court {
    ...
    private double racketSpeedA = 350.0; // m/s pour changer la taille d'une raquette pour les pouvoirs
    private double racketSpeedB = 350.0; // m/s pour changer la taille d'une raquette pour les pouvoirs
    ...
    private boolean isFun = true;//pour savoir si on est dans le mode fun
...
//          System.out.println((width/4)*difficulty);
    ...
    public void useCurrentPowerA() {
        ...
        case BIGGER : racketSizeA += 100;this.nowTimerA = this.time+2.0e+9;break;
        ...
        case FASTER : racketSpeedA *= 2;this.nowTimerA = this.time+5.0e+9;break;
    ...
    public void useCurrentPowerB() {
        ...
        case BIGGER : racketSizeB += 100;this.nowTimerB = this.time+2.0e+9;break;
        ...
        case FASTER : racketSpeedB *= 2;this.nowTimerB = this.time+5.0e+9;break;
