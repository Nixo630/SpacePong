...
public class GameStart {
	...
	public void parametre() {
		...
		choix_ball_earth.setPrefSize(width*(2.5912/100),height*(5.9/100));
	...
	public void jouer_solo(int i) {
		...
		//court.setIsFun(i==4);a changer plus tard l'argument de setIfFun() pour savoir quand utiliser le mode fun
		//gw.setIsFun(i==4);
		visible_change(getMenuButton(),true);
