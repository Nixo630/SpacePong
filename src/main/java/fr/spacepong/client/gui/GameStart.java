...
public class GameStart {
	...
	public GameStart (Pane startRoot,Pane root,Scene courtScene, GameView gw,Court court) {
		...
		title = new Button();
		title.setId("title");
		title.getStylesheets().addAll(this.getClass().getResource("/gui/style.css").toExternalForm());
		...
		play.getStylesheets().addAll(this.getClass().getResource("/gui/style.css").toExternalForm());
	    ...
	    Image j = new Image(getClass().getResourceAsStream("/gui/curseur_droit.png"));
	    ...
	    Image i = new Image(getClass().getResourceAsStream("/gui/curseur_gauche.png"));
		...
		multiplay.getStylesheets().addAll(this.getClass().getResource("/gui/style.css").toExternalForm());
		...
		retour = new Button();
		retour.setId("return");
		retour.getStylesheets().addAll(this.getClass().getResource("/gui/style_setting.css").toExternalForm());
		...
		setting_button.getStylesheets().addAll(this.getClass().getResource("/gui/style.css").toExternalForm());
		...
		start_button.getStylesheets().addAll(this.getClass().getResource("/gui/style.css").toExternalForm());
	...
	public void parametre() {
		...
		title_s = new Button();
		title_s.getStylesheets().addAll(this.getClass().getResource("/gui/style_setting.css").toExternalForm());
		title_s.setId("title");
		...
		title_choix_bg.getStylesheets().addAll(this.getClass().getResource("/gui/style_setting.css").toExternalForm());
		...
		choix_galaxie.getStylesheets().addAll(this.getClass().getResource("/gui/style_setting.css").toExternalForm());
		...
		choix_trou_noir.getStylesheets().addAll(this.getClass().getResource("/gui/style_setting.css").toExternalForm());
		...
		choix_earth.getStylesheets().addAll(this.getClass().getResource("/gui/style_setting.css").toExternalForm());
		...
		choix_earth2.getStylesheets().addAll(this.getClass().getResource("/gui/style_setting.css").toExternalForm());
		...
		finish_button.getStylesheets().addAll(this.getClass().getResource("/gui/style_setting.css").toExternalForm());
		...
		title_middle_bar.getStylesheets().addAll(this.getClass().getResource("/gui/style_setting.css").toExternalForm());
		...
		middle_bar_yes.getStylesheets().addAll(this.getClass().getResource("/gui/style_setting.css").toExternalForm());
		...
		middle_bar_no.getStylesheets().addAll(this.getClass().getResource("/gui/style_setting.css").toExternalForm());
		...
		title_ball_skin.getStylesheets().addAll(this.getClass().getResource("/gui/style_ball.css").toExternalForm());
		...
		choix_ball_sun.getStylesheets().addAll(this.getClass().getResource("/gui/style_ball.css").toExternalForm());
		...
		choix_ball_green.getStylesheets().addAll(this.getClass().getResource("/gui/style_ball.css").toExternalForm());
		...
		choix_ball_moon.getStylesheets().addAll(this.getClass().getResource("/gui/style_ball.css").toExternalForm());
		...
		choix_ball_jupiter.getStylesheets().addAll(this.getClass().getResource("/gui/style_ball.css").toExternalForm());
		...
		choix_ball_saturne.getStylesheets().addAll(this.getClass().getResource("/gui/style_ball.css").toExternalForm());
		...
		choix_ball_lila.getStylesheets().addAll(this.getClass().getResource("/gui/style_ball.css").toExternalForm());
		...
		choix_ball_earth.getStylesheets().addAll(this.getClass().getResource("/gui/style_ball.css").toExternalForm());
		...
		title_racket_difficult.getStylesheets().addAll(this.getClass().getResource("/gui/style_setting.css").toExternalForm());
		...
		points_bg.getStylesheets().addAll(this.getClass().getResource("/gui/style_setting.css").toExternalForm());
	...
	public void print_setting_racket_difficulty() {
		...
		title_racket_difficulty.getStylesheets().addAll(this.getClass().getResource("/gui/style_setting.css").toExternalForm());
		...
		button_yes.getStylesheets().addAll(this.getClass().getResource("/gui/style_setting.css").toExternalForm());
		...
		button_no.getStylesheets().addAll(this.getClass().getResource("/gui/style_setting.css").toExternalForm());
	...
	public void chose_difficulty() {
		...
		easy.getStylesheets().addAll(this.getClass().getResource("/gui/style.css").toExternalForm());
		...
		medium.getStylesheets().addAll(this.getClass().getResource("/gui/style.css").toExternalForm());
		...
		hard.getStylesheets().addAll(this.getClass().getResource("/gui/style.css").toExternalForm());
		...
		insane.getStylesheets().addAll(this.getClass().getResource("/gui/style.css").toExternalForm());
	...
	public void choose_multiplay() {
		...
		button_1vs1.getStylesheets().addAll(this.getClass().getResource("/gui/style.css").toExternalForm());
		...
		button_2vs2.getStylesheets().addAll(this.getClass().getResource("/gui/style.css").toExternalForm());
		...
		online.getStylesheets().addAll(this.getClass().getResource("/gui/style.css").toExternalForm());
